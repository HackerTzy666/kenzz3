...
│                                                                           crack fb 1.0       │
└──────────────────────────────────────────────────────────────────────────────────────────────┘  	
			{m} ☯︎ {k} ☯︎ {h} ☯︎ {sir} Recode : Kenzz{x}{m} ☯︎ {k} ☯︎ {h} ☯︎ {x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t( ͠° ͟ʖ ͡°) HackerTzy666 : [green]🇨 🇴 🇰 🇮  [white] (;´༎ຶٹ༎ຶ`)'))
...
def menu(my_name,my_id):
	...
	_____Kenzz_____ = input('\n➪ Pilih : ')
	if _____Kenzz_____ in ['1']:
		dump_massal()
	elif _____Kenzz_____ in ['2']:
		dump_follower()
	elif _____Kenzz_____ in ['3']:
		error()
	elif _____Kenzz_____ in ['4']:
		crack_file()
	elif _____Kenzz_____ in ['5']:
		result()
	elif _____Kenzz_____ in ['0']:
